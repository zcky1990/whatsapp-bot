...
const WhatsAppConnection = () => {
  const { qrCode, isConnected, status, retryCount, initializeWhatsApp } = useWhatsApp();

  const handleInitialize = () => {
    initializeWhatsApp();
    toast.info('Initializing WhatsApp...');
  };
  ...
  return (
    <div>
      ...
      {isConnected ? (
        // Show only connection details when connected
        <div className="card">
        ...
        // Show full interface when not connected
        <div className="card">
          <div className="text-center mb-20">
            <div style={{ marginBottom: '20px' }}>
              {statusInfo.icon}
          ...
          <div className="card">
            ...
            <div style={{ 
              ...
              <ul style={{ marginTop: '10px', paddingLeft: '20px' }}>
                ...
                <li>Try refreshing the page and clicking "Initialize WhatsApp" again</li>
      ...
      {isConnected && (
        /* Connection Status Details - Only show when connected */
        <div className="card">
          <h3>Connection Details</h3>
          <div style={{ marginTop: '15px' }}>
            <div style={{ 
